// source: http://stemrobotics.cs.pdx.edu/node/7268
...
@Autonomous(name="MattIMUPIDTurn", group="MatrixPrimeBot")
//@Disabled
public class MattIMUPIDTurn extends LinearOpMode
{
    DcMotor                 leftMotor;
    DcMotor                 rightMotor;
    ...
    public void runOpMode() // throws InterruptedException
    {
        ...
        while (opModeIsActive() && !imu.isGyroCalibrated()) // !isStopRequested()
        {
            sleep(50);
            idle();
        }
        ...
        while (opModeIsActive() && !touched)
        {
            ...
            if (touched)
            {
                ...
                if (aButton) rotate(-90, power); // !touched || 
